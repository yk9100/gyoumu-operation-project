  ...
  <a-spin :spinning="spinning">
    ...
    >
      ...
      <a-form-item
        label="姓（よみ）"
        name="frontNameYomi"
        :rules="[{ required: true, message: '姓（よみ）を入力してください' }]"
      >
      ...
      <a-form-item
        label="名（よみ）"
        name="lastNameYomi"
        :rules="[{ required: true, message: '名（よみ）を入力してください' }]"
      >
      ...
      <a-form-item
        ...
        name="icon"
        :rules="[
          { required: false, message: 'アイコンをアップロードしてください' },
        ]"
      >
      ...
      <a-form-item name="employmentType" label="雇佣形态" required>
        <a-select v-model:value="formState.employmentType">
          <a-select-option value="employmentType1">雇用形態1</a-select-option>
          <a-select-option value="employmentType2">雇用形態2</a-select-option>
          <a-select-option value="employmentType3">雇用形態3</a-select-option>
          <a-select-option value="employmentType4">雇用形態4</a-select-option>
        </a-select>
      </a-form-item>
      ...
      <a-form-item name="notificationPriority" label="お知らせ表示優先順位">
        <a-input type="number" v-model:value="formState.notificationPriority" />
      </a-form-item>
